package edu.skidmore.cs376b.junitdemo.basicquery;
...
public class SuffixFileFilter extends FileFilter
{
    ...
    /**
     * Check whether the supplied file's name agrees with this suffix file
     * filter. If not (e.g. the suffix is not a match) then append the first
     * suffix in the list for this filter to the filename and return it.
